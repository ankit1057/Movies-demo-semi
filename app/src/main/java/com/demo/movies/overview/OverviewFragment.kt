...
import com.demo.movies.databinding.FragmentOverviewBinding
import com.demo.movies.network.MovieTypes
import com.demo.movies.overview.OverviewFragmentDirections.actionOverviewFragmentToDetailFragment as actionOverviewFragmentToDetailFragment1
...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        overviewViewModel.onNavigationToDetail.observe(this, Observer {
            it?.let {
                this.findNavController().navigate(actionOverviewFragmentToDetailFragment1(it))
